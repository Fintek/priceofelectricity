...
async function main(): Promise<void> {
  ...
  const electricityCostCalculatorLandingEntity = {
    ...
    excerpt:
      "Estimate monthly electric bills by state. Compare 500, 1000, 1500, and 2000 kWh bill scenarios and appliance operating costs.",
    qualityScore: 85,
    freshnessStatus: "aging" as const,
    tokens: [
      "electricity",
  ...
  const kwhCostCalculatorHubEntity = {
    id: "electricity-hubs-usage:index",
    type: "landing" as const,
    slug: "electricity-hubs-usage",
    title: "kWh Cost Calculator",
    canonicalUrl: ensureAbsoluteUrl("/electricity-hubs/usage"),
    excerpt:
      "Interactive kWh cost calculator: enter any electricity usage and see estimated cost by state or U.S. average using EIA residential rates.",
    qualityScore: 88,
    freshnessStatus: "aging" as const,
    tokens: [
      "kwh",
