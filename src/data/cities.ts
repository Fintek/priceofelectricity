...
export const CITIES: City[] = [
  ...
  { stateSlug: "california", slug: "san-jose", name: "San Jose", population: 970000, avgRateCentsPerKwh: 31.8 },
  { stateSlug: "california", slug: "san-francisco", name: "San Francisco", population: 810000, avgRateCentsPerKwh: 31.8 },
  { stateSlug: "california", slug: "fresno", name: "Fresno", population: 550000, avgRateCentsPerKwh: 30.7 },
  { stateSlug: "california", slug: "sacramento", name: "Sacramento", population: 525000, avgRateCentsPerKwh: 30.5 },

  // Texas
  { stateSlug: "texas", slug: "houston", name: "Houston", population: 2300000, avgRateCentsPerKwh: 15.6 },
  { stateSlug: "texas", slug: "san-antonio", name: "San Antonio", population: 1490000, avgRateCentsPerKwh: 16.5 },
  { stateSlug: "texas", slug: "dallas", name: "Dallas", population: 1300000, avgRateCentsPerKwh: 16.5 },
  { stateSlug: "texas", slug: "austin", name: "Austin", population: 980000, avgRateCentsPerKwh: 16.2 },
  { stateSlug: "texas", slug: "fort-worth", name: "Fort Worth", population: 960000, avgRateCentsPerKwh: 16.3 },
  { stateSlug: "texas", slug: "el-paso", name: "El Paso", population: 680000, avgRateCentsPerKwh: 15.9 },

  // Florida
  { stateSlug: "florida", slug: "jacksonville", name: "Jacksonville", population: 990000, avgRateCentsPerKwh: 15.6 },
  { stateSlug: "florida", slug: "miami", name: "Miami", population: 460000, avgRateCentsPerKwh: 15.4 },
  { stateSlug: "florida", slug: "tampa", name: "Tampa", population: 400000, avgRateCentsPerKwh: 15.4 },
  { stateSlug: "florida", slug: "orlando", name: "Orlando", population: 320000, avgRateCentsPerKwh: 15.4 },
  { stateSlug: "florida", slug: "st-petersburg", name: "St. Petersburg", population: 270000, avgRateCentsPerKwh: 15.4 },
  { stateSlug: "florida", slug: "hialeah", name: "Hialeah", population: 220000, avgRateCentsPerKwh: 15.6 },

  // New York
  { stateSlug: "new-york", slug: "new-york-city", name: "New York City", population: 8330000, avgRateCentsPerKwh: 24.9 },
  { stateSlug: "new-york", slug: "buffalo", name: "Buffalo", population: 275000, avgRateCentsPerKwh: 23.2 },
  ...
  { stateSlug: "illinois", slug: "aurora", name: "Aurora", population: 180000, avgRateCentsPerKwh: 17.0 },
  ...
  { stateSlug: "pennsylvania", slug: "pittsburgh", name: "Pittsburgh", population: 303000, avgRateCentsPerKwh: 18.0 },
  { stateSlug: "pennsylvania", slug: "allentown", name: "Allentown", population: 126000, avgRateCentsPerKwh: 17.8 },
  ...
  { stateSlug: "ohio", slug: "cleveland", name: "Cleveland", population: 370000, avgRateCentsPerKwh: 17.1 },
  { stateSlug: "ohio", slug: "cincinnati", name: "Cincinnati", population: 310000, avgRateCentsPerKwh: 17.1 },
  { stateSlug: "ohio", slug: "toledo", name: "Toledo", population: 265000, avgRateCentsPerKwh: 16.8 },
  ...
  { stateSlug: "georgia", slug: "augusta", name: "Augusta", population: 202000, avgRateCentsPerKwh: 15.2 },
  { stateSlug: "georgia", slug: "columbus", name: "Columbus", population: 206000, avgRateCentsPerKwh: 15.3 },
  ...
  { stateSlug: "arizona", slug: "tucson", name: "Tucson", population: 545000, avgRateCentsPerKwh: 16.0 },

  // North Carolina
  { stateSlug: "north-carolina", slug: "charlotte", name: "Charlotte", population: 880000, avgRateCentsPerKwh: 14.4 },
  { stateSlug: "north-carolina", slug: "raleigh", name: "Raleigh", population: 470000, avgRateCentsPerKwh: 14.2 },
  ...
  { stateSlug: "tennessee", slug: "memphis", name: "Memphis", population: 630000, avgRateCentsPerKwh: 13.5 },
  ...
  // Minnesota
  { stateSlug: "minnesota", slug: "minneapolis", name: "Minneapolis", population: 430000, avgRateCentsPerKwh: 16.2 },

  // Missouri
  { stateSlug: "missouri", slug: "kansas-city", name: "Kansas City", population: 510000, avgRateCentsPerKwh: 13.6 },
  { stateSlug: "missouri", slug: "st-louis", name: "St. Louis", population: 290000, avgRateCentsPerKwh: 13.5 },

  // Nevada
  { stateSlug: "nevada", slug: "las-vegas", name: "Las Vegas", population: 650000, avgRateCentsPerKwh: 13.8 },

  // Virginia
  { stateSlug: "virginia", slug: "virginia-beach", name: "Virginia Beach", population: 460000, avgRateCentsPerKwh: 15.4 },
