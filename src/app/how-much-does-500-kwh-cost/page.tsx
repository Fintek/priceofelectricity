...
const USAGE_KWH = 500;
const BASE_PATH = "/how-much-does-500-kwh-cost";

export const dynamic = "force-static";
export const revalidate = 86400;

export const metadata: Metadata = buildMetadata({
  title: "How Much Does 500 kWh Cost? | PriceOfElectricity.com",
  description:
    "Estimate electricity cost for 500 kWh. Cost depends on your state's rate. See national average and state-by-state estimates.",
...
export default async function HowMuchDoes500KwhCostPage() {
  ...
  const breadcrumbJsonLd = buildBreadcrumbListJsonLd([
    { name: "Home", url: "/" },
    { name: "How Much Does 500 kWh Cost?", url: BASE_PATH },
  ]);
    ...
    <>
      ...
      <main className="container">
        <nav aria-label="Breadcrumb" className="muted" style={{ marginBottom: 16, fontSize: 14 }}>
          ...
          {" · "}
          <span aria-current="page">How Much Does 500 kWh Cost?</span>
        </nav>

        <h1 style={{ fontSize: 32, marginBottom: 12 }}>How Much Does 500 kWh Cost?</h1>

        <section style={{ marginBottom: 32 }}>
          <p style={{ marginTop: 0, marginBottom: 16, maxWidth: "65ch", fontSize: 16, lineHeight: 1.6 }}>
            500 kWh per month represents low electricity usage—typical for small apartments, minimal air conditioning,
            or energy-efficient homes. Your actual cost depends on your electricity rate, which varies by state and utility.
          </p>
          <p style={{ marginTop: 0, marginBottom: 16, maxWidth: "65ch", fontSize: 16, lineHeight: 1.6 }}>
            Electricity cost = rate (¢/kWh) × usage (kWh). State electricity rates differ widely across the U.S.,
            so the same 500 kWh can cost significantly more or less depending on where you live.
          </p>
        ...
        <section style={{ marginBottom: 32 }}>
          <h2 style={{ fontSize: 20, marginBottom: 12 }}>500 kWh Cost by State</h2>
          <p style={{ margin: "0 0 16px 0", maxWidth: "65ch", fontSize: 14 }}>
            Select a state to see the estimated cost of 500 kWh at that state&apos;s average residential rate.
          </p>
          <div
            style={{
              display: "grid",
