...
export const metadata: Metadata = buildMetadata({
  title: "How Much Does 2000 kWh Cost? | PriceOfElectricity.com",
  description:
    "Estimate electricity cost for 2000 kWh. Cost depends on your state's rate. See national average and state-by-state estimates.",
...
export default async function HowMuchDoes2000KwhCostPage() {
    ...
    <>
      ...
      <main className="container">
        <nav aria-label="Breadcrumb" className="muted" style={{ marginBottom: 16, fontSize: 14 }}>
          ...
          {" · "}
          <span aria-current="page">How Much Does 2000 kWh Cost?</span>
        </nav>

        <h1 style={{ fontSize: 32, marginBottom: 12 }}>How Much Does 2000 kWh Cost?</h1>

        <section style={{ marginBottom: 32 }}>
          <p style={{ marginTop: 0, marginBottom: 16, maxWidth: "65ch", fontSize: 16, lineHeight: 1.6 }}>
            2000 kWh per month represents high electricity usage—typical for large homes, electric heating or cooling,
            pools, or multiple high-consumption appliances. Your actual cost depends on your electricity rate.
          </p>
          <p style={{ marginTop: 0, marginBottom: 16, maxWidth: "65ch", fontSize: 16, lineHeight: 1.6 }}>
            Electricity cost = rate (¢/kWh) × usage (kWh). State electricity rates differ widely across the U.S.,
            so the same 2000 kWh can cost significantly more or less depending on where you live.
          </p>
        ...
        <section style={{ marginBottom: 32 }}>
          <h2 style={{ fontSize: 20, marginBottom: 12 }}>2000 kWh Cost by State</h2>
          <p style={{ margin: "0 0 16px 0", maxWidth: "65ch", fontSize: 14 }}>
            Select a state to see the estimated cost of 2000 kWh at that state&apos;s average residential rate.
          </p>
          <div
            style={{
              display: "grid",
